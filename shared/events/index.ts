import $ from 'jquery';
import {WrapperHelper} from "@/shared/designPattern/Singleton.ts";
...
export function trigger_wrapper_jquery_event(event_name: keyof typeof ALL_DOM_EVENTS, args?: any = null) {
    WrapperHelper
        .then(({$ui, dom}) => {
